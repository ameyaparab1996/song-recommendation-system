...
def display_recommendations(spotify_df):
    ...
    def update_include(value):
        spotify_df['include'] = include
        spotify_df.loc[6, 'include'] = value
    ...
    for j in range(0, len(spotify_df)):
        ...
        include[j] = playlist_col.checkbox("",key=j, value=spotify_df.iloc[j, 6], label_visibility="collapsed", on_change=update_include(value))
    #st.stop()
